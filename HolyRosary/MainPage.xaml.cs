...
namespace HolyRosary
{
    ...
    public partial class MainPage : ContentPage
    {
        ...
        static string pray1BY = "    У імя Айца і Сына, і Духа Святога. Амэнь. ";
        static string pray1 = "";
        ...
        static string pray2BY = "       Веру ў Бога, Айца ўсемагутнага, Стварыцеля неба і замлі, і ў Езуса Хрыста, Сына Яго адзінага, Пана нашага," +
            ...
            "жывых і памерлых. Веру ў Духа Святога, святы Касцёл каталіцкі, еднасць святых, адпушчэнне грахоў, уваскрашэнне цела, жыцце вечнае. Амэн.  ";
        static string pray2 = "";
        ...
        static string pray3BY = "Ойча наш, каторы ёсць у небе, свяціся імя Тваё, прыйдзі Валадарства Тваё, будзь воля Твая як у небе так і на зямлі." +
            " Хлеба нашага штодзеннага дай нам сёння, і адпусці нам правіны нашы, як і мы адпускаем вінаватым нашым, і не ўводзь нас у спакусу, але збаў" +
            "нас ад злога. Амэн. ";
        static string pray3 = "";
